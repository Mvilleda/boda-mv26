...
const translations = {
    en: {
        ...
        stayHotelsTitle: "cabañas la finca #2",
        stayHotelsText: "18 cabins · total capacity 66 guests. Code: VALERIA&MARCOS.",
        stayHotelsItem1: "Cabin rates: Saturday MXN 2,000–4,200 · Friday/Sunday MXN 1,400–2,900 · Monday-Thursday MXN 1,000–2,100.",
        stayHotelsItem2: "Totals (18 cabins): Saturday MXN 51,600 · Friday/Sunday MXN 36,120 · Monday-Thursday MXN 25,800.",
        stayHotelsItem3: "Holiday Saturdays, long weekends, or vacation periods: promotions do not apply.",
        stayHotelsLink: "View cabin options on Booking.com",
        stayAirbnbTitle: "hotel bv atlixco",
        stayAirbnbText: "Open code: BODA VALERIA & MARCOS.",
        stayAirbnbItem1: "Mention the code when calling or sending WhatsApp to apply the wedding rate.",
        stayAirbnbItem2: "Check availability and room types directly with the hotel.",
        stayAirbnbItem3: "Please review the PDF with booking code details.",
        stayAirbnbLink: "Visit Hotel BV Atlixco website",
        stayAirbnbPdf: "Open booking code PDF",
    ...
    es: {
        ...
        stayHotelsTitle: "cabañas la finca #2",
        stayHotelsText: "18 cabañas · capacidad total 66 personas. Código: VALERIA&MARCOS.",
        stayHotelsItem1: "Tarifas por cabaña: sábado $2,000-$4,200 · viernes/domingo $1,400-$2,900 · lunes-jueves $1,000-$2,100.",
        stayHotelsItem2: "Totales (18 cabañas): sábado $51,600 · viernes/domingo $36,120 · lunes-jueves $25,800.",
        stayHotelsItem3: "Sábados festivos, puentes o vacaciones: no aplican promociones.",
        stayHotelsLink: "Ver opciones de cabañas en Booking.com",
        stayAirbnbTitle: "hotel bv atlixco",
        stayAirbnbText: "Código abierto: BODA VALERIA & MARCOS.",
        stayAirbnbItem1: "Menciona el código al llamar o enviar WhatsApp para que apliquen la tarifa de boda.",
        stayAirbnbItem2: "Consulta disponibilidad y tipos de habitación directamente con el hotel.",
        stayAirbnbItem3: "Revisa también el PDF con la información del código y reserva.",
        stayAirbnbLink: "Visitar sitio de Hotel BV Atlixco",
        stayAirbnbPdf: "Abrir PDF del código de reserva",
